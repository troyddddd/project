...
/**
 * Framework provided by jiuzhang.com.
 * completed by Yijun Dai
 */
public class Multiplication {
	...
	public static class MultiplicationReducer extends Reducer<Text, Text, Text, DoubleWritable> {
		...
		public void reduce(Text key, Iterable<Text> values, Context context)
			...
			// key = movieId
			// value = < movieA1 = relation, movie2 = relation, ..... user1: 10, ....>
			// need two maps to collect value from 2 mappers
			// Map1 -> RelationMap
			//Map2 -> UserRatingMap
